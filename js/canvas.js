...
class Bubble {
    ...
    init() {
        /*Генерируем цвет шарика */
        this.color = COLORS[Math.floor(Math.random() * COLORS.length)];
        /*свойство alpha класса   */
        this.alpha = generateDecimalBetween(5, 10) / 10;
        /*свойство size класса  */
        this.size = generateDecimalBetween(1, 3);
        /* Координаты начальной позиции шарика по гооизонтали и вертикали */
